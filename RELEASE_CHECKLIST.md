...
- [x] Document public ESA Φ-lab / AI4EO OrbitalAI provenance and third-party rights status for `third_party/phisat2_exec/*.bin`.
- [ ] Archive any explicit written redistribution/license notice for the simulator assets if/when one is provided.
...
- [x] Verify no credentials, tokens, local absolute paths, or downloaded mission data are committed.
